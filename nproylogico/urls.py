...
urlpatterns = [
    ...
    path('farmacias/geolocalizar/', views.geolocalizar_farmacias, name='geolocalizar_farmacias'),
    path('farmacias/<int:pk>/', views.detalle_farmacia, name='detalle_farmacia'),
    path('farmacias/<int:pk>/modificar/', views.modificar_farmacia, name='modificar_farmacia'),
    ...
    path('motorista/panel/', views.panel_motorista, name='panel_motorista'),
    ...
    path('operadora/ia-sugerencias/', views.ia_sugerencias, name='ia_sugerencias'),
    path('operadora/geolocalizacion/', views.geolocalizacion_panel, name='geolocalizacion_panel'),
